  ...
  try {
    ...
    if (countries.length === 0) {
      const defaultCountries = [
        ...
        { id: 'italy', name: 'Italy', code: 'ITA', currency: 'EUR', flag: '🇮🇹', active: true },
        { id: 'spain', name: 'Spain', code: 'ESP', currency: 'EUR', flag: '🇪🇸', active: true },
        { id: 'netherlands', name: 'Netherlands', code: 'NLD', currency: 'EUR', flag: '🇳🇱', active: true },
        { id: 'belgium', name: 'Belgium', code: 'BEL', currency: 'EUR', flag: '🇧🇪', active: true },
        { id: 'switzerland', name: 'Switzerland', code: 'CHE', currency: 'CHF', flag: '🇨🇭', active: true },
        { id: 'austria', name: 'Austria', code: 'AUT', currency: 'EUR', flag: '🇦🇹', active: true },
        { id: 'sweden', name: 'Sweden', code: 'SWE', currency: 'SEK', flag: '🇸🇪', active: true },
        { id: 'norway', name: 'Norway', code: 'NOR', currency: 'NOK', flag: '🇳🇴', active: true },
        { id: 'denmark', name: 'Denmark', code: 'DNK', currency: 'DKK', flag: '🇩🇰', active: true },
        { id: 'finland', name: 'Finland', code: 'FIN', currency: 'EUR', flag: '🇫🇮', active: true },
        { id: 'ireland', name: 'Ireland', code: 'IRL', currency: 'EUR', flag: '🇮🇪', active: true },
        { id: 'portugal', name: 'Portugal', code: 'PRT', currency: 'EUR', flag: '🇵🇹', active: true },
        { id: 'poland', name: 'Poland', code: 'POL', currency: 'PLN', flag: '🇵🇱', active: true },
        { id: 'czechia', name: 'Czech Republic', code: 'CZE', currency: 'CZK', flag: '🇨🇿', active: true },
        { id: 'hungary', name: 'Hungary', code: 'HUN', currency: 'HUF', flag: '🇭🇺', active: true },
        { id: 'croatia', name: 'Croatia', code: 'HRV', currency: 'EUR', flag: '🇭🇷', active: true },
        ...
        { id: 'taiwan', name: 'Taiwan', code: 'TWN', currency: 'TWD', flag: '🇹🇼', active: true },
        { id: 'hongkong', name: 'Hong Kong', code: 'HKG', currency: 'HKD', flag: '🇭🇰', active: true },
        { id: 'uae', name: 'United Arab Emirates', code: 'ARE', currency: 'AED', flag: '🇦🇪', active: true },
        { id: 'israel', name: 'Israel', code: 'ISR', currency: 'ILS', flag: '🇮🇱', active: true },
        { id: 'chile', name: 'Chile', code: 'CHL', currency: 'CLP', flag: '🇨🇱', active: true },
        { id: 'brazil', name: 'Brazil', code: 'BRA', currency: 'BRL', flag: '🇧🇷', active: true },
        { id: 'mexico', name: 'Mexico', code: 'MEX', currency: 'MXN', flag: '🇲🇽', active: true },
        { id: 'uruguay', name: 'Uruguay', code: 'URY', currency: 'UYU', flag: '🇺🇾', active: true },
        { id: 'estonia', name: 'Estonia', code: 'EST', currency: 'EUR', flag: '🇪🇪', active: true },
        { id: 'latvia', name: 'Latvia', code: 'LVA', currency: 'EUR', flag: '🇱🇻', active: true },
        { id: 'lithuania', name: 'Lithuania', code: 'LTU', currency: 'EUR', flag: '🇱🇹', active: true },
        { id: 'slovenia', name: 'Slovenia', code: 'SVN', currency: 'EUR', flag: '🇸🇮', active: true },
        { id: 'slovakia', name: 'Slovakia', code: 'SVK', currency: 'EUR', flag: '🇸🇰', active: true },
        { id: 'luxembourg', name: 'Luxembourg', code: 'LUX', currency: 'EUR', flag: '🇱🇺', active: true },
      ];
